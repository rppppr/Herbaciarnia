        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <%
                    ...
                    out.print(data.getHeaderForProductKind(request.getParameter("kind")));
                    ArrayList allProductsToShow = data.WriteProducts(request.getParameter("kind"));
                    for(int i = 0 ; i < allProductsToShow.size() ; i++)
                    {
                        out.print(allProductsToShow.get(i));
                    }
                %>
            </div>
        </div>
